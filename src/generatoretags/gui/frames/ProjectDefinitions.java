 ...
 */
package generatoretags.gui.frames;

import generatoretags.data.ProjectResource;
import generatoretags.data.ints.ResourceType;
import generatoretags.gui.renders.ProjectResourceRender;
...
public class ProjectDefinitions extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        ImageIcon DBIcon = new ImageIcon(new ImageIcon(getClass().getResource("/generatoretags/resources/database.png")).getImage().getScaledInstance(20, 20, Image.SCALE_DEFAULT));
